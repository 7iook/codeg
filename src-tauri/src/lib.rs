...
mod tauri_app {
    ...
    use crate::commands::{
        ...
        // [merge-v0.29] union: + upstream canvas_commands and open_in.
    ...
    pub fn run() {
        ...
        builder
            ...
            .invoke_handler(tauri::generate_handler![
                ...
                conversations::conversation_session_file,
                ...
                acp_commands::acp_preview_cancel_scope,
                acp_commands::acp_cancel_with_scope_token,
